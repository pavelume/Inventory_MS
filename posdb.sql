...
CREATE TABLE `brandtb` (
  `Brand` varchar(35) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Brand`)
...
INSERT INTO `brandtb` VALUES ('Adidas'),('Adven'),('Donear'),('Duke'),('Flying Machine'),('John Player'),('Law Man'),('Nike'),('Turtle'),('US Polo');
...
INSERT INTO `categorytb` VALUES ('Capri'),('Cotton Pant'),('Half-Pant'),('Jeans'),('Kurta'),('Pajama'),('Shirt'),('T-Shirt'),('Trouser'),('Underwear'),('Vest');
/*!40000 ALTER TABLE `categorytb` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `modeltb`
--

DROP TABLE IF EXISTS `modeltb`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `modeltb`
--

LOCK TABLES `modeltb` WRITE;
/*!40000 ALTER TABLE `modeltb` DISABLE KEYS */;
INSERT INTO `modeltb` VALUES ('L'),('M'),('S'),('XL'),('XXL');
/*!40000 ALTER TABLE `modeltb` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orderstb` (
  `TransactionID` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `TransactionDate` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `TransactionTime` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `CustomerNumber` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `stocktb` (
  ...
  `ItemName` varchar(55) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `StockDate` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `StockTime` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TDay` int(11) DEFAULT NULL,
  `TMonth` int(11) DEFAULT NULL,
  `TYear` int(11) DEFAULT NULL,
...
LOCK TABLES `stocktb` WRITE;
/*!40000 ALTER TABLE `stocktb` DISABLE KEYS */;
INSERT INTO `stocktb` VALUES ('P909234','Adven Capri','Capri','Adven','XL',999,'3/4/2021','9:53:35',3,4,2021),('T668923','Turtle T-Shirt','T-Shirt','Turtle','S',1199,'3/4/2021','9:56:21',3,4,2021),('U83923','Turtle Shirt','Shirt','Turtle','M',1299,'3/4/2021','9:56:21',3,4,2021),('U83992','US Polo T-Shirt','T-Shirt','US Polo','S',1299,'3/4/2021','9:51:28',3,4,2021),('W72891','Flying Machine Jeans','Jeans','Flying Machine','M',1499,'3/4/2021','9:52:22',3,4,2021);
/*!40000 ALTER TABLE `stocktb` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `warehouse` (
  `TransactionID` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ItemName` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Category` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Brand` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Size` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2022-06-22 12:37:23
